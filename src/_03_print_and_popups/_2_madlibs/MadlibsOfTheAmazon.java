...
String adj = JOptionPane.showInputDialog(null,"adjective");
		// Get the player to enter a type of liquid
String liq = JOptionPane.showInputDialog(null,"liquid");
		// Get the player to enter a body part
String part = JOptionPane.showInputDialog(null,"body part");
		// Get the player to enter a verb
String verb = JOptionPane.showInputDialog(null,"verb");
		// Get the player to enter a place
String place = JOptionPane.showInputDialog(null,"place");
